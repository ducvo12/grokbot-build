    ...
    <ThemeProvider>
      <FolioProviders>
        ...
        <div className="relative mx-auto min-h-screen w-full max-w-[1440px] px-0 md:px-4 md:py-6">
          <div className="relative min-h-screen overflow-hidden border-y border-rule bg-paper transition-colors duration-300 md:min-h-[calc(100vh-3rem)] md:border md:shadow-[0_40px_80px_-48px_rgb(28_25_20_/_0.7)]">
